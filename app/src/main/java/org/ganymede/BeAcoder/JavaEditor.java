...
public class JavaEditor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_java_editor);
            ...
            public void onClick(View view) {
                ...
                execute.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        try {
                            ...
                            if(response.isSuccessful()){
                                ...
                                Toast.makeText(JavaEditor.this, response.errorBody().string(), Toast.LENGTH_SHORT).show();
                            }

                        } catch (JSONException e) {
                            Toast.makeText(JavaEditor.this, "Gagal Parsing JSON : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<String> call, Throwable t) {
                        ...
                        Toast.makeText(JavaEditor.this, "Gagal : " + t.getMessage(), Toast.LENGTH_SHORT).show();
